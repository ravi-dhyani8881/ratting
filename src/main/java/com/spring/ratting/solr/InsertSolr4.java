...
//public class InsertSolr4 {
//
//    public static void main(String[] args) throws SolrServerException {
//        String solrUrl = "http://localhost:8983/solr/like"; // Replace with your Solr URL
...
//            
//            
//            document.addField("likeId",  UUID.randomUUID().toString());
//
