...
public class InsertSolr2 {

    public static void main(String[] args) throws SolrServerException {
        String solrUrl = "http://localhost:8983/solr/review"; // Replace with your Solr URL
        ...
        for (int i = 1; i <= iterations; i++) {
            ...
            document.addField("reviewComments", "reviewComments ");

            document.addField("reviewRatting", generateRating());
            document.addField("reviewUserId", "cecea004-1b91-41ae-a21b-176f4254b31e");
            document.addField("reviewContentId", "70");
